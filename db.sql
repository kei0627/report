create table player ( id int auto_increment not null primary key, player_name varchar(100), country varchar(100) );
create table team ( id int auto_increment not null primary key, team_name varchar(100) );
create table team2 ( id int auto_increment not null primary key, team2_name varchar(100) );
