create table player ( id int auto_increment not null primary key, playername varchar(100), country varchar(100) );
create table team ( id int auto_increment not null primary key, teamname varchar(100) );
